...
public class BookmarkListFragment extends Fragment implements ApiCallback {
    View layout;
    String postId;
    String sessionId;
    ...
    private void getBookmarkList() throws JSONException {
        ...
        apiCall.apiRequestPost(getActivity(), obj, Config.URL_BOOKMARK_LIST_POST,"likeBookmarkByPost", apiCallback);
    }
    ...
    private void loadDataIntoView(JSONObject response) throws JSONException {
        JSONArray likeListArray = response.getJSONArray("users");
